        ...
        <div className="cart-container">
          {carts.length ? (
                        ...
                        <div className="cart-product-info">
                          ...
                          <div className="cart-name">
                            ...
                            <div className="delete-cart">
                              <button
                                onClick={() =>
                                  dispatch(deleteCartThunk(el?.id))
                                }
                              >
                                Remove
                              </button>
                  ...
                  <div className="checkout-box">
                    ...
                    <div className="text-under-card">
                      <div className="text-total">
                        <span className="text-items">Item(s) total:</span>
                        <span>${sum.toFixed(2)}</span>
                      </div>
                      <div className="text-discount">
                        <span className="text-shop-discount">
                          Shop discount
                        </span>
                        <span className="text-0">-$0.00</span>
                      </div>
                      <div className="text-subtotal">
                        <span className="text-subtotal-only">Subtotal</span>
                        <span className="subtotal-number">
                          ${sum.toFixed(2)}
                        </span>
                      </div>
                      <div className="text-free-shipping">
                        <span className="text-shipping">Shipping</span>
                        <span className="text-0">FREE</span>
                      </div>
                      <div>
            ...
            <div className="fourth-part">
              <i class="fa-solid fa-leaf"></i>
              <span>
                Nansty offsets carbon emissions from every delivery
              </span>
            </div>
          </>
          )
