...
const GetCategories = () => {
  ...
  const allProducts = useSelector(
    (state) => state.categories.categories[id]?.products
  );
            ...
            <div className="cate_all_products_container" key={el.id}>
              <NavLink to={`/products/${el.id}`}>
                ...
                />
                  ...
                  {/* <div className="all-product-name">{el?.name}</div> */}
              ...
              <div className="getall_review_stars">
                ...
                <span className="cate_review_num">({el?.review_nums})</span>
              </div>

              <div className="cate_product_price">${el?.price}</div>
            </div>
          ))}
        </div>
      </div>
